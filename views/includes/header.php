...
<head>
	<title>iphone | iphone decoded</title>
	<link rel="icon" type="image/x-icon" href="<?php echo URL; ?>public/images/bsu.png">
	<!-- Required meta tags -->
	<meta charset="utf-8">
	...
	<link rel="stylesheet" href="<?php echo URL;?>public/styles/custom2.css">
...
<body id="headercolor" class="colllor d-flex flex-column h-100 justify-content-between">
	<header>
				...
				<div class="row">
					<nav class="navbar navbar-expand-lg">
						<div class="container-fluid">
							<a class="navbar-brand" href="<?php echo URL; ?>home"><img src="<?php echo URL; ?>public/images/bsu.png" alt="iphonespecs ni Tulas" width="120"></a>
								...
								<div>
									<div class="d-flex justify-content-end mb-3">
										<?php if(isset($_SESSION["user"])):?>
											<p>Hello <?php echo $_SESSION["user"]["name"];?> ! <a href="<?php echo URL; ?>user/logout" class="text-reset text-decoration-none d-inline-block mx-3"><i class="bi bi-box-arrow-right"></i> Log Out</a></p>
											<?php else: ?>
